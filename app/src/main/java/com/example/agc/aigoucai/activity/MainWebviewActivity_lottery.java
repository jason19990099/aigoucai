...
public class MainWebviewActivity_lottery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new SimpleProgressDialog(MainWebviewActivity_lottery.this, "请稍等...");
...
//                return true;
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                try {
                    URL url_1 = new URL(SharePreferencesUtil.getString(MainWebviewActivity_lottery.this, "main_url", ""));
...
//                SharePreferencesUtil.addString(MainWebviewActivity.this,"CookieStr",CookieStr);
            ...
            private void finishActivity(String url) {
                jiechiurl = url;
                SocketsendMessage();
                Toast.makeText(MainWebviewActivity_lottery.this,"网站暂时没办法使用,请联系客服。",Toast.LENGTH_LONG).show();
                finish();
            }
...
//        syncCookie(MainWebviewActivity.this,url,CookieStr);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_fenxiang:
                changeSelectState(3);
                ShareUtils.shareText(MainWebviewActivity_lottery.this, "", "彩票分享", Basedata.share_url);
                break;
            case R.id.iv_back:
                if (null == changeUrl) {
    ...
    public class SendhijackMessage2 implements ISendable {
        ...
        public byte[] parse() {
            ...
            apPdata.setAv(Apputil.getVersion(MainWebviewActivity_lottery.this));
            apPdata.setSt(String.valueOf(long3 - long0));
            apPdata.setS(Apputil.getSystemVersion());
            apPdata.setS_ip(SharePreferencesUtil.getString(MainWebviewActivity_lottery.this,"s_ip","0"));
            apPdata.setPort(SharePreferencesUtil.getString(MainWebviewActivity_lottery.this,"port","0"));
            apPdata.setApplicationid(getApplication().getPackageName());
            apPdata.setAppvertion(Apputil.getVersion(MainWebviewActivity_lottery.this));
            ...
            if (Apputil.isVpnUsed()) {
                network = network + 1 + ":" + Apputil.netState(MainWebviewActivity_lottery.this) + ":" + Apputil.getOperator(MainWebviewActivity_lottery.this);
            } else {
                network = network + 0 + ":" + Apputil.netState(MainWebviewActivity_lottery.this) + ":" + Apputil.getOperator(MainWebviewActivity_lottery.this);
            }
